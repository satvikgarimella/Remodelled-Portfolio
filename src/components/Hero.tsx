    ...
    >
      ...
      <div className="container max-w-5xl mx-auto text-center z-10">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight tracking-tighter">
          ...
          <AnimatedText text="I'm " className="inline-block" delay={1000} speed={50} /> {/* Fixed spacing */}
          <AnimatedText
        ...
        <h2 className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto">
          <AnimatedText
            text="I love building smart, efficient solutions with AI and automation. Always creating, always innovating."
            delay={2400}
            speed={30}
          />
        </h2>
